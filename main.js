...
function getAllParagraphs() {
    return myPage.querySelectorAll("p");
}
...
function makeItalic() {
    const pars = document.querySelectorAll('.even');
    pars.forEach( (par) => {
...
function createBorders () {
    const table = document.querySelector('#myPage');
    table.forEach( (tab) => {
    table.addRule('border 2px solid black');
    });
return table;
}
